...
?>
				<nav id="mainNav">
					<ul>
						...
						<li><a href="reportes_usuariosa.php"><span>Reportes usuarios</span></a></li>
						<li><a href="reportes_ingresos.php"><span>Reportes ingresos</span></a></li>
...
?>
				<nav id="mainNav">
					<ul>
						<li class="active">
                        <li><a href="index.php"><span>Inicio</span></a></li>
						<li><a href="ingreso_vehiculo.php"><span>Ingreso veh&iacute;culo</span></a></li>
						<li><a href="salida_vehiculo.php"><span>Salida veh&iacute;culo </span></a></li>
