...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO vehiculos (placa, tipo_vehiculo, fecha_llegada, hora_llegada, usuario_llegada, fecha_salida, hora_salida, usuario_salida, transcurrido, valor_cobro, tipo_cobro) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<form action="salida_vehiculo.php" method="post">
...
?>      	        
<form action="salida_vehiculo.php" method="post" name="form1">
  <table align="center">
    <tr>
    ...
    <tr>
      ...
      <td><input name="fecha_salida" type="text" disabled="disabled" value="<?php echo  $dia_salida?>" size="32" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td nowrap="nowrap" align="right">Transcurrido:</td>
...
<?php 
$sql="UPDATE `parqueadero`.`vehiculos`
